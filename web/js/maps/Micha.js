...
***************************************************************************/
	...
	// Fill Planet
	Universe.planet("Micha").add( new Map(null, 5120,5120 ) );
	/*
...
//	LoadScript('js/marks/Micha.js',true);
	/*	Load Map Marks	*/
//	LoadScript('js/marks/Micha-.js',true);
/***************************************************************************
						Exception handling.
...
***************************************************************************/
if(gLoadScript)	gLoadScript.SizeLoaded += 2253;
