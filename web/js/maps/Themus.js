...
***************************************************************************/
	...
	// Fill Planet
	Universe.planet("Themus").add( new Map("Themus", 5120,5120, "Themus") );
	Universe.planet("Themus").add( new Map(null, 5120,5120 ) );
	/*
...
//	LoadScript('js/marks/Themus.js',true);
	/*	Load Map Marks	*/
//	LoadScript('js/marks/Themus-.js',true);
/***************************************************************************
						Exception handling.
***************************************************************************/
	...
	var str, oError;
	str = 'Universe.planet("Themus").add()\n\n';
	str += e.name + ' in: ';
...
***************************************************************************/
if(gLoadScript)	gLoadScript.SizeLoaded += 2332;
