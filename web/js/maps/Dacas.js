...
***************************************************************************/
	...
	// Fill Planet
	Universe.planet("Dacas").add( new Map(null, 5120,5120 ) );
	/*
...
//	LoadScript('js/marks/Dacas.js',true);
	/*	Load Map Marks	*/
//	LoadScript('js/marks/Dacas-.js',true);
/***************************************************************************
						Exception handling.
...
***************************************************************************/
if(gLoadScript)	gLoadScript.SizeLoaded += 2244;
