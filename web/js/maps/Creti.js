...
***************************************************************************/
	...
	// Fill Planet
	Universe.planet("Creti").add( new Map(null, 5120,5120 ) );
	/*
...
//	LoadScript(js/marks/Creti.js',true);
	/*	Load Map Marks	*/
//	LoadScript('js/marks/Creti-.js',true);
/***************************************************************************
						Exception handling.
...
***************************************************************************/
if(gLoadScript)	gLoadScript.SizeLoaded += 2243;
